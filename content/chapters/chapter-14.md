...
Karpathy closed the transmission window. He walked back to the master whiteboard. At the very edge of the architectural blueprints, he scrawled a compact administrative metric:
`Canadian Passport Expiration: March 15, 2028.`
...
Karpathy walked up to the master whiteboard, picked up a marker, and wrote the number:
`47x`

Right beside the metric, he penned:
`Pre-optimization.`
